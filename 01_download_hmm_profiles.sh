...
# Date: 2025
# Description: Downloads HMM profiles from InterPro/Pfam and NCBI CDD,
#              and consolidates them into a single indexed database for HMMER search.
...
# ---------------------------------------------------------------------------
# PARAMETERS — edit the profile list to match your protein family of interest
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Step 1: Download Pfam profiles from InterPro
# Add or remove entries to match your domain set of interest
# Format: output_name.hmm  PF_accession
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Step 2: Download CDD profiles from NCBI
# Add or remove entries to match your domain set of interest
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Step 3: Consolidate and index all profiles
# ---------------------------------------------------------------------------
