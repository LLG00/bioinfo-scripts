# BLAST Coverage Parser

Calculates **query and subject coverage** from BLAST XML output by merging overlapping HSP intervals — avoiding double-counting of regions hit by multiple HSPs.
